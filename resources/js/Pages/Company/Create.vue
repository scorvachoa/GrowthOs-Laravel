...
<template>
    <AppLayout>
        <div class="max-w-2xl mx-auto">
            <div class="mb-6">
                <button @click="router.get('/company')"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nueva empresa</h1>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Crea una nueva empresa en la plataforma</p>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        <input v-model="form.name" type="text" required placeholder="Ej: Mi Empresa S.A."
                    ...
                    <div>
                        ...
                        <div v-if="logoPreview" class="flex items-center gap-4 mb-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-sm text-gray-500">Previsualización</span>
                            <button type="button" @click="logoPreview = null; form.logo = null"
                                class="ml-auto text-xs px-2 py-1 rounded-lg bg-red-600 text-white">Quitar</button>
                        </div>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <PrimaryButton type="submit" class="w-full justify-center">
                            <Building2 class="w-4 h-4" /> Crear empresa
                        </PrimaryButton>
                    </div>
                </form>
            </div>
