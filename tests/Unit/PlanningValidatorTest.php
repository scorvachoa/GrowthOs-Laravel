...
class PlanningValidatorTest extends TestCase
{
    ...
    public function test_assert_working_day_passes_for_saturday_when_included(): void
    {
        $this->expectNotToPerformAssertions();
        $this->validator->assertWorkingDay('2026-06-20', [1, 2, 3, 4, 5, 6]);
    }

    public function test_assert_working_day_passes_for_sunday_when_included(): void
    {
        $this->expectNotToPerformAssertions();
        $this->validator->assertWorkingDay('2026-06-21', [0, 1, 2, 3, 4, 5, 6]);
    }
    ...
    public function test_resolve_block_returns_first_valid_for_empty_string(): void
    {
        $settings = [
            'block_hours' => 2,
            'default_work_start' => '09:00',
        ...
        $result = $this->validator->resolveBlock($settings, '');
        $this->assertEquals('09:00-11:00', $result);
    }

    public function test_resolve_block_with_custom_settings(): void
    {
        $settings = [
            'block_hours' => 1,
        ...
        $result = $this->validator->resolveBlock($settings, '08:00-09:00');
        $this->assertEquals('08:00-09:00', $result);
    }
}
